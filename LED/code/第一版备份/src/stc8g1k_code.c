...
static u8 overtemperature_check(void);
...
static void gpio_config(void)
{
   ...
   //数码管引脚初始化
	 P3_MODE_OUT_PP(GPIO_Pin_4 |GPIO_Pin_5 |GPIO_Pin_7);   //推挽输出A B C
	 P1_MODE_OUT_PP(GPIO_Pin_0 |GPIO_Pin_2 |GPIO_Pin_3 |GPIO_Pin_4);   //推挽输出D E F G 
	 P1_MODE_OUT_PP(GPIO_Pin_5 |GPIO_Pin_6);   //推挽输出DIG1 DIG2
	 P15 = 0; P16=0;  //数码管不显示
	 //触摸IC引脚初始化 
